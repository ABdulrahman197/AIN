...
namespace AIN.Infrastructrue.Migrations
{
    ...
    [Migration("20250929002803_transportProject")]
    partial class transportProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIN.Core.Entites.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AIN.Core.Entites.Like", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AIN.Core.Entites.Comment", b =>
                {
                    ...
                    b.HasOne("AIN.Core.Entites.UserAccount", "User")
                        .WithMany()
